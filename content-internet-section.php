 <div class="row">
    ...
    <div id="nbn" class="col s12 m12 l10 offset-l1">
        <div class="internetCard card">
                        ...
                        <table class="hoverable centered">
                            <thead class="blue-grey darken-4 white-text">
                                  <tr>
                                      ...
                                      <th data-field="setUpFee">Set Up Fee</th>
                                      <th data-field="monthlyFee">Monthly Fee</th>
            ...
            <div class="card-panel blue-grey darken-4 white-text"><p class="flow-text center">Please Note: Only downloads count towards your quota  - uploads are not counted</p></div>
            <div class="card-panel red darken-4 white-text"><p class="flow-text center">1 x 4 port Wirelss modem $150 (NBN Ready)</p></div>
        <br>
        <table class="hoverable centered">
                            <thead class="blue-grey darken-4 white-text">
                                  <tr>
